...
#Tạo sparksession và kết nối với 2 cổng của cassandra
spark = SparkSession \
    .builder \
...
#Đưa dữ liệu đã đọc vào cahc và xóa các cột thông tin thiếu
...
#Điều chỉnh data năm 2019 để phù hợp với streaming layer
...
#Gộp các file lại và lưu vào hdfs
